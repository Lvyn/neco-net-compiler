...
TGenericPlaceType_TARGS void TGenericPlaceType_CLS::clean()
{
    assert(0);
    mSize = 0;
}

TGenericPlaceType_TARGS void TGenericPlaceType_CLS::decrement_ref()
{
    mRefs--;
    if (mRefs == 0)
        delete this;
...
TGenericPlaceType_TARGS void TGenericPlaceType_CLS::increment_ref()
{
    mRefs++;
}

TGenericPlaceType_TARGS bool TGenericPlaceType_CLS::not_empty() const
{
    return mSize > 0;
}

TGenericPlaceType_TARGS char* TGenericPlaceType_CLS::cstr() const
{
...
TGenericPlaceType_TARGS int TGenericPlaceType_CLS::equals(const TGenericPlaceType< DataType >& right) const
{
    int i;
    int tmp;
...
TGenericPlaceType_TARGS int TGenericPlaceType_CLS::compare(const TGenericPlaceType< DataType >& right) const
{
    int i;
    int tmp;
    int this_size;
...
TGenericPlaceType_TARGS int TGenericPlaceType_CLS::hash() const
{
    int i    = mSize - 1;
...
TGenericPlaceType_TARGS void TGenericPlaceType_CLS::add(DataType value)
{
    int i, j;
    if (mSize >= mMaxSize)
    {
...
TGenericPlaceType_TARGS void TGenericPlaceType_CLS::remove_by_index(int index)
{
    mSize--;
...
TGenericPlaceType_TARGS void TGenericPlaceType_CLS::remove_by_value(DataType value)
{
    int index = 0;
...
TGenericPlaceType_TARGS const DataType& TGenericPlaceType_CLS::get(int index) const
{
    return mData[index];
}

TGenericPlaceType_TARGS int TGenericPlaceType_CLS::size() const
{
    return mSize;
}

TGenericPlaceType_TARGS void TGenericPlaceType_CLS::update(const TGenericPlaceType& right)
{
    assert(0);
}

TGenericPlaceType_TARGS int TGenericPlaceType_CLS::index_of(const DataType& value) const
{
    for (int i = 0; i < mSize; ++i)
    {
        if (mData[i] == value)
...
TPid_TARGS bool TPid_CLS::operator==(const TPid< T >& right)
{
...
TPid_TARGS int TPid_CLS::compare(const TPid< T >& right)
{
    for (size_t i = 0; i < right.mData.size(); ++i)
    {
...
TGeneratorPlaceType_TARGS void TGeneratorPlaceType_CLS::update_pid_counter(const PidType& pid, CounterType counter)
{
...
TGeneratorPlaceType_TARGS void TGeneratorPlaceType_CLS::remove_pid(const PidType& pid)
{
    for (int i = 0; i < this->mSize; ++i)
    {
        DataType_t& current = this->mData[i];
