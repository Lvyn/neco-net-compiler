...
# asdl.py --output=cython/cyast.py cython/cython.asdl
# timestamp: 2011-06-27 11:32:32.244446
...
class CDef (language):
    _fields = ('public',)
    _attributes = ()
    def __init__ (self, public=None, **ARGS):
        language.__init__(self, **ARGS)
        self.public = public
...
class Cast (expr):
    ...
    _attributes = ('lineno', 'col_offset')
    def __init__ (self, target, value, lineno=0, col_offset=0, **ARGS):
        expr.__init__(self, **ARGS)
        self.target = target
        self.value = value
        self.lineno = int(lineno)
...
class FunctionDef (stmt):
    _fields = ('name', 'args', 'body', 'returns', 'lang', 'decl')
    _attributes = ('lineno', 'col_offset')
    def __init__ (self, name, args, lang, body=[], returns=None, decl=[], lineno=0, col_offset=0, **ARGS):
...
class ClassDef (stmt):
    _fields = ('name', 'bases', 'body', 'lang', 'decl')
    _attributes = ('lineno', 'col_offset')
    def __init__ (self, name, lang, bases=[], body=[], decl=[], lineno=0, col_offset=0, **ARGS):
        stmt.__init__(self, **ARGS)
        self.name = name
...
class CFor (stmt):
    _fields = ('start', 'start_op', 'target', 'stop_op', 'stop', 'body')
    _attributes = ('lineno', 'col_offset')
    def __init__ (self, start, start_op, target, stop_op, stop, body=[], lineno=0, col_offset=0, **ARGS):
        stmt.__init__(self, **ARGS)
        self.start = start
...
class CImportFrom (stmt):
    ...
    _attributes = ('lineno', 'col_offset')
    def __init__ (self, module, names=[], lineno=0, col_offset=0, **ARGS):
        stmt.__init__(self, **ARGS)
        self.module = module
        self.names = list(names)
        self.lineno = int(lineno)
...
class Extern (stmt):
    _fields = ('type', 'name', 'args')
    _attributes = ('lineno', 'col_offset')
    def __init__ (self, type, name, args=[], lineno=0, col_offset=0, **ARGS):
        stmt.__init__(self, **ARGS)
        self.type = type
        self.name = name
        self.args = list(args)
...
class ExternFrom (stmt):
    _fields = ('hfile', 'body')
    _attributes = ('lineno', 'col_offset')
    def __init__ (self, hfile=None, body=[], lineno=0, col_offset=0, **ARGS):
        stmt.__init__(self, **ARGS)
        self.hfile = hfile
        self.body = list(body)
        self.lineno = int(lineno)
...
class Comment (stmt):
    _fields = ('message',)
    _attributes = ('lineno', 'col_offset')
    def __init__ (self, message, lineno=0, col_offset=0, **ARGS):
        stmt.__init__(self, **ARGS)
...
class Print (stmt):
    ...
    _attributes = ('lineno', 'col_offset')
    def __init__ (self, nl, dest=None, values=[], lineno=0, col_offset=0, **ARGS):
        stmt.__init__(self, **ARGS)
        self.dest = dest
        self.values = list(values)
        self.nl = nl
...
class CVar (cdecl):
    _fields = ('name', 'type', 'init', 'public', 'inner')
    _attributes = ()
    def __init__ (self, name, type, init=None, public=None, inner=None, **ARGS):
        cdecl.__init__(self, **ARGS)
        self.name = name
        self.type = type
        self.init = init
        self.public = public
...
class CFunction (cdecl):
    _fields = ('type', 'name', 'args')
    _attributes = ()
    def __init__ (self, type, name, args=[], **ARGS):
        cdecl.__init__(self, **ARGS)
        self.type = type
        self.name = name
        self.args = list(args)
...
class CStruct (cdecl):
    _fields = ('name', 'body', 'public', 'inner')
    _attributes = ()
    def __init__ (self, name, body=[], public=None, inner=None, **ARGS):
        cdecl.__init__(self, **ARGS)
        self.name = name
        self.body = list(body)
        self.public = public
