...
# snakes/lang/asdl.py --output=snakes/lang/cython/asdl.py snakes/lang/cython/cython.asdl
# timestamp: 2010-11-17 15:59:58.875779
...
class CFor (stmt):
    _fields = ('start', 'start_op', 'target', 'stop_op', 'stop')
    _attributes = ('lineno', 'col_offset')
    def __init__ (self, start, start_op, target, stop_op, stop, lineno=0, col_offset=0, **ARGS):
        stmt.__init__(self, **ARGS)
        self.start = start
